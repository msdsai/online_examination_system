...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
			...
			// txtUsername
			// 
			this->txtUsername->Location = System::Drawing::Point(166, 71);
			...
			// txtPassword
			// 
			this->txtPassword->Location = System::Drawing::Point(166, 195);
			...
			this->btnSignUp->Location = System::Drawing::Point(108, 261);
			this->btnSignUp->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->btnSignUp->Name = L"btnSignUp";
			this->btnSignUp->Size = System::Drawing::Size(142, 35);
			...
			// txtEmail
			// 
			this->txtEmail->Location = System::Drawing::Point(166, 139);
			this->txtEmail->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->txtEmail->Name = L"txtEmail";
			this->txtEmail->Size = System::Drawing::Size(148, 26);
			...
			this->label2->Location = System::Drawing::Point(75, 139);
			...
			this->label3->Location = System::Drawing::Point(64, 195);
			...
			this->ClientSize = System::Drawing::Size(380, 379);
...
#pragma endregion
    ...
    private: System::Void btnSignUp_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (email->EndsWith("@iitg.ac.in")) { // Valid email address
